-- Simple migration script to merge subscriptions table into users table
-- This script adds columns one by one to avoid syntax issues

USE milk_delivery;

-- Step 1: Add subscription-related columns to users table one by one
ALTER TABLE users
