    ...
    try {
        ...
        if (existingUser.length > 0) {
            ...
            const [userResult] = await connection.execute(
                'INSERT INTO users (username, email, name, password, subscription_status, subscription_type, subscription_duration, subscription_end_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
                ['testuser@gmail.com', 'testuser@gmail.com', 'Test User', 'password123', 'active', '1L Daily', '7days', '2025-01-30']
            );
