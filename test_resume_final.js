...
async function testResumeFinal() {
    try {
        console.log('Testing resume functionality - Final Test...');

        // Create a test user
        const timestamp = Date.now();
        const username = 'test_resume_final_' + timestamp;
        const email = 'test_resume_final_' + timestamp + '@example.com';

        const userData = {
            username: username,
            email: email,
            password: 'password123',
            name: 'Test Resume Final',
            phone: '1234567890',
